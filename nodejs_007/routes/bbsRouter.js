 ...
 *
 * 1. queryString
 *    'http://localhost:3000/bbs/detail?b_id=3;' 처럼 보낼 때
 *    'req.query.b_id' 로 받음
 *    const b_id = req.query.b_id
 *
 * 2. body
 *    form의 POST로 전송했을 때
 *    'req.body.b_title'.. 등등으로 받음
 ...
 *    router.get("/reply/delete/{rid}")로 URL path를 설정하고 req.params.rid로 데이터를 받는다.
 *    'const rid = req.params.rid'와 같이 받음
 *
 */
